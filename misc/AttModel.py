...
class Attention2(nn.Module):
    ...
    def forward(self, h, att_feats, p_att_feats, mask):
        ...
        # FF: modify warning, change mask with 0/1 to False/True
...
class CascadeCore(nn.Module):
    def __init__(self, opt):
        ...
        self.fg_mask = Parameter(opt.fg_mask.float())
    ...
    def forward(self, fg_idx, pool_feats, rnn_outs, roi_labels, seq_batch_size, seq_cnt):
        ...
        # FF: Fix the masked_fill do not use float type. It should be bool type.
